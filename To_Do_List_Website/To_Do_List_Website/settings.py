...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "To_Do_List_Website" / "templates"],    #project-level templates
...
WSGI_APPLICATION = 'To_Do_List_Website.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.2/ref/settings/#databases

#Runs PostgreSQL if environmental variables are set up, otherwise runs SQLite
